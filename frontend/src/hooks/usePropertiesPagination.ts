 ...
 *
 * Deliberately a thin wrapper around `useState`: Properties.tsx's refetch
 ...
 * pager in Properties.tsx.
 */
export function getPageWindow(page: number, pages: number, windowSize = PAGE_WINDOW): number[] {
