...
```
 ...
 docs/features/BIN-166-scraper-framework.md    | Point at adaptive funnel behavior
 docs/features/BIN-62-scraper-adaptive-funneling.md | NEW — this note
```
...
- Related prior work: `docs/features/BIN-166-scraper-framework.md`, `BIN-178-fix-quintoandar-olx-scrapers.md`, BIN-62.
