...
```
 ...
 docs/features/BIN-95-selective-ai-enrichment-rerun.md | NEW — this note
 docs/features/BIN-180-enrich-missing.md                | cross-link recalculate vs AI re-run
 docs/features/BIN-94-blend-neighbourhood-profiles-scoring-ui.md | point at this feature
