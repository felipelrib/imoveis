...
```
 ...
 docs/features/BIN-47-appconfig-proxy-settings.md             | NEW — this doc
...
- Related: BIN-48 (rotating proxy in scraper HTTP layer) — **done**
  (`docs/features/BIN-48-rotating-proxy-scraper-http.md`); BIN-49 (operator enablement /
  observability) — **done** (`docs/features/BIN-49-operator-proxy-observability.md`).
