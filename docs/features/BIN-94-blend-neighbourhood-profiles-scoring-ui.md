...
```
 ...
 docs/features/BIN-94-blend-neighbourhood-profiles-scoring-ui.md | NEW — this doc
...
4. After prompt/model/verdict changes: Dashboard **AI Enrichment re-run** (or
   `POST /admin/enrichment/rerun`) — see `docs/features/BIN-95-selective-ai-enrichment-rerun.md`.
...
- Related: BIN-85 epic, BIN-86 profile schema, BIN-95 selective AI re-run
  (`docs/features/BIN-95-selective-ai-enrichment-rerun.md`).
