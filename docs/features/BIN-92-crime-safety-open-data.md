...
| SEJUSP regional counts (PBH regionais) | Regional | **Ship BH** — see [BIN-96-bh-crime-safety-rates.md](BIN-96-bh-crime-safety-rates.md) |
...
| [Fogo Cruzado API](https://api.fogocruzado.org.br/docs) | Lat/lon | **Not viable for MG/SP** — covers RJ/PE/BA/PA only ([90](BIN-120-fogo-cruzado-mg-sp-feasibility.md), BIN-120) |
...
```
 ...
 docs/features/BIN-92-crime-safety-open-data.md                    | NEW — this doc
...
- BH unlock (done in BIN-96): regional SEJUSP counts → neighbourhood rates; bairro LAI extracts via `build_bh_safety_rates.py --bairro-csv`. See docs/features/BIN-96-bh-crime-safety-rates.md.
- Fogo Cruzado MG/SP: closed in BIN-120 — API does not cover MG/SP; no ingest. See [BIN-120-fogo-cruzado-mg-sp-feasibility.md](BIN-120-fogo-cruzado-mg-sp-feasibility.md).
