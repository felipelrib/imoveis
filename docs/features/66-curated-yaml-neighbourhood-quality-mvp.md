...
```
 ...
 docs/features/66-curated-yaml-neighbourhood-quality-mvp.md      | NEW — this doc
...
- Schema/API foundation: [BIN-86](https://linear.app/felipelrib/issue/BIN-86) / docs/features/65-neighbourhood-quality-profile-schema-api.md.
