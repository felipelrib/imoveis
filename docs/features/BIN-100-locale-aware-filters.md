...
- BIN-103: multi-locale extensibility checklist — see `docs/i18n/add-a-locale.md` / `docs/features/BIN-103-product-i18n.md`.
- Pets SQL QuintoAndar-amenity-only follow-up shipped in BIN-110 / `docs/features/BIN-110-olx-accepts-pets-filter.md`.
