...
```
 ...
 docs/features/94-prefer-primary-listing-grid.md         | NEW — this doc
 docs/features/26-canonical-property-projection.md       | UPDATE — follow-up done
 docs/features/27-multi-select-properties-comparison.md  | UPDATE — follow-up done
```
