...
```
 ...
 docs/features/BIN-81-olx-venda-nova-listing-type.md | NEW — this note
```
...
- Dual listings that store a single rent price as `sale` are reclassified to rent; when **both** prices exist they now become two `property_listings` rows — see [88-olx-dual-rent-sale-listings](BIN-108-olx-dual-rent-sale-listings.md) (BIN-108).
