...
`docs/features/BIN-12-deal-summary-enrichment.md` (and a sibling line in `BIN-168-ai-enrichment.md`)
...
**Source:** `docs/features/BIN-97-pt-corpus-ai-locale-audit.md` Notes / Follow-ups.
...
- Point explicitly at [BIN-101-localize-ai-tags-verdicts.md](BIN-101-localize-ai-tags-verdicts.md) /
...
```
 docs/features/BIN-12-deal-summary-enrichment.md           | Refresh locale behaviour + SoT links
 docs/features/BIN-168-ai-enrichment.md                     | Locale-aware deal verdict wording
 docs/features/BIN-97-pt-corpus-ai-locale-audit.md         | Mark stale-doc follow-up resolved
 docs/features/BIN-126-refresh-deal-summary-feature-doc.md  | NEW — this note
```
...
1. Open `docs/features/BIN-12-deal-summary-enrichment.md` — title/Approach must not claim
