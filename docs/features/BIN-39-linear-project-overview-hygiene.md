...
- Numbered as `25-*` after merging `main` (BIN-38 claimed `BIN-38-semantic-search-reconcile.md`).
...
```
docs/features/BIN-39-linear-project-overview-hygiene.md | NEW — this feature doc
...
5. Confirm `docs/features/BIN-38-semantic-search-reconcile.md` (BIN-38) and this `25-*` doc both exist on `main` after merge.
