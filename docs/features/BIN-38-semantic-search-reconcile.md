...
- Audited main after PR [#16](https://github.com/felipelrib/imoveis/pull/16): pgvector migration, embed pipeline, `GET /properties?q=`, admin backfill, Properties search box, unit/integration tests, and `docs/features/BIN-18-semantic-search.md` are all present.
...
```
docs/features/BIN-38-semantic-search-reconcile.md                              | NEW — this feature doc
docs/features/BIN-18-semantic-search.md                                        | Note BIN-38 reconcile closed
...
1. Confirm `docs/features/BIN-18-semantic-search.md` and this doc exist.
...
- **Decision:** No new Linear story for semantic-search gaps. Known limits stay in `BIN-18-semantic-search.md` (null embeddings excluded from `q=`, re-embed on non-noop scrape).
