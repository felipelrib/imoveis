...
> Feature branch: `ai/enrich-ram-tune` · Linear: `BIN-187` · Status: implemented
...
```
 ...
 docs/features/BIN-187-ai-enrich-ram-concurrency.md | NEW — this doc
 mkdocs.yml                                    | nav link
...
- Related: `docs/features/BIN-73-ai-qwen-vl-bge-m3.md`, `docs/features/BIN-182-photo-gate-floor-8.md`.
