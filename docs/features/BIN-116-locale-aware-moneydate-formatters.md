...
```
 ...
 docs/features/BIN-116-locale-aware-moneydate-formatters.md | NEW — this doc
 docs/features/BIN-98-locale-foundation.md               | follow-up → shipped / BIN-116
 docs/features/BIN-99-full-ui-string-catalog.md          | Notes — BIN-116 reconcile
```
