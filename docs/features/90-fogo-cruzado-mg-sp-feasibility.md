...
```
 ...
 docs/features/90-fogo-cruzado-mg-sp-feasibility.md   | NEW — this doc
 docs/features/72-crime-safety-open-data.md           | UPDATE — spike row + follow-up → BIN-120 decision
```
...
- Related: BIN-92 (crime open-data), BIN-96 (BH rates), feature [72](72-crime-safety-open-data.md).
