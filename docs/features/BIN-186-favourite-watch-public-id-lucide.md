...
> Feature branch: `fix/favourite-watch-uuid-and-icons` · Linear: `BIN-186` · Status: implemented
...
```
 ...
 docs/features/BIN-186-favourite-watch-public-id-lucide.md   | NEW — this doc
```
