...
```
 ...
 docs/features/BIN-13-favourites-and-saved-searches.md           | Auth note
 docs/features/BIN-10-watchlist-price-drop-alerts.md             | Owner note
 docs/features/BIN-44-appconfig-api-credential.md                | Story 2.3 done
