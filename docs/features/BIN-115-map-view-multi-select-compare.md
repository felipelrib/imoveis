...
```
 ...
 docs/features/BIN-115-map-view-multi-select-compare.md      | NEW — this feature doc
```
...
- Closes the map multi-select follow-up called out in `docs/features/BIN-42-multi-select-properties-comparison.md` and `BIN-43-side-by-side-compare-view.md`.
