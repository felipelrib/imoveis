...
```
 ...
 docs/features/BIN-71-isolate-integration-test-db.md | NEW — this doc
```
...
- Redis `flushdb` isolation shipped as BIN-117 / `docs/features/BIN-117-isolate-redis-test-db.md`
