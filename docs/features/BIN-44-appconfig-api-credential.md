...
```
 ...
 docs/features/BIN-172-rest-api.md                | Point auth at AppConfig
 docs/features/BIN-176-admin-control-panel.md     | Dual-accept note + AppConfig
...
- Story 2.2 ([BIN-46](https://linear.app/felipelrib/issue/BIN-46)): **done** — frontend credential gate (`docs/features/BIN-46-frontend-credential-gate.md`); SPA attaches `X-API-Key` from sessionStorage.
- Story 2.3 ([BIN-45](https://linear.app/felipelrib/issue/BIN-45)): **done** — owner-scoped favourites / saved searches / watchlist (`docs/features/BIN-45-owner-scoped-favourites-searches-watchlist.md`).
