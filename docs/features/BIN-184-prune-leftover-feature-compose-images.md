...
> Feature branch: `feat/docker-temp-cleanup-harness` · Linear: `BIN-184` · Status: implemented
...
```
 ...
 docs/features/BIN-184-prune-leftover-feature-compose-images.md | NEW — this doc
 docs/features/BIN-181-docker-cleanup-after-wrapup.md | Point follow-up at this enhancement
