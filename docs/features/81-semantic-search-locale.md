...
```
 ...
 docs/features/20-semantic-search.md                | Locale notes + bge-m3 / 1024-d correction
 docs/features/78-pt-corpus-ai-locale-audit.md      | Cross-link 8.6 shipped
 docs/features/81-semantic-search-locale.md         | NEW — this note
