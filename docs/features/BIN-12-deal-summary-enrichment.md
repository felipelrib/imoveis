...
1. **Deterministic template** (`template_deal_verdict()` in `adapters/ai/client.py`):
   ...
   - Default generation language is **English** (`en`); `pt-BR` phrases exist for the
     active UI locale (see [BIN-101-localize-ai-tags-verdicts.md](BIN-101-localize-ai-tags-verdicts.md)
...
owned by [BIN-101-localize-ai-tags-verdicts.md](BIN-101-localize-ai-tags-verdicts.md) (BIN-101).
...
[BIN-64-english-listing-accuracy.md](BIN-64-english-listing-accuracy.md) (BIN-64).
...
- **AI locale SoT:** [BIN-101-localize-ai-tags-verdicts.md](BIN-101-localize-ai-tags-verdicts.md) /
...
- Doc refresh (remove stale PT-BR-only claims): [BIN-126](https://linear.app/felipelrib/issue/BIN-126)
  / [BIN-126-refresh-deal-summary-feature-doc.md](BIN-126-refresh-deal-summary-feature-doc.md).
