...
```
 ...
 docs/features/BIN-54-assign-properties-spatial-containment.md | NEW — this doc
...
- GIST on `properties.location`: shipped as BIN-121 / `docs/features/BIN-121-gist-index-properties-location.md`.
