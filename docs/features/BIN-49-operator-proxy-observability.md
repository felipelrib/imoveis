...
```
 ...
 docs/features/BIN-49-operator-proxy-observability.md     | NEW — this doc
...
- Frontend dashboard widgets for proxy mode: **done** in BIN-124 (`docs/features/BIN-124-proxy-dashboard-widgets.md`).
