...
> Feature branch: `feat/enrich-missing-button` · Linear: `BIN-180` · Status: implemented
...
```
 ...
 docs/features/BIN-180-enrich-missing.md               | NEW — this note
```
...
- **Recalculate vs AI re-run:** Recalculate All Scores refreshes stat/combined math after
  ...
  selective AI re-run panel (`docs/features/BIN-95-selective-ai-enrichment-rerun.md`, BIN-95).
