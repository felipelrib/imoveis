...
> Feature branch: `feat/user-prefs` · Linear: `BIN-13` · Status: implemented
...
- Owner scoping ([BIN-45](https://linear.app/felipelrib/issue/BIN-45) / `docs/features/BIN-45-owner-scoped-favourites-searches-watchlist.md`): routes require `X-API-Key`; rows are scoped by `owner = Principal.id`.
