...
```
 ...
 docs/features/BIN-99-full-ui-string-catalog.md        | NEW — this doc
...
- BIN-100: locale-aware filter labels + PT synonym → EN wire — see `docs/features/BIN-100-locale-aware-filters.md`.
- BIN-101: localize AI tags / verdicts / score *payload* copy (only chrome labels shipped here).
- BIN-116: money/date formatter follow-up from feature 77 — already shipped here; closed with dedicated regression specs in `BIN-116-locale-aware-moneydate-formatters.md`.
