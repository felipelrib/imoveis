...
```
 ...
 docs/features/BIN-46-frontend-credential-gate.md     | NEW — this doc
 docs/features/BIN-44-appconfig-api-credential.md     | Story 2.2 follow-up marked done
 docs/features/BIN-176-admin-control-panel.md          | SPA gate note updated
