...
```
 ...
 docs/features/90-gist-index-properties-location.md              | NEW — this doc
 docs/features/28-load-neighbourhood-polygons.md                 | Follow-up → BIN-121
 docs/features/31-assign-properties-spatial-containment.md       | Follow-up → BIN-121
```
