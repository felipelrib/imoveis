...
```
 ...
 docs/features/BIN-89-transit-proximity.md              | UPDATE — Notes point at BIN-118
 docs/features/BIN-118-persist-transit-stops.md          | NEW — this doc
```
...
- GTFS service frequency / headways: shipped in BIN-119 /
  `docs/features/BIN-119-gtfs-transit-headways.md` (computed at file refresh into
