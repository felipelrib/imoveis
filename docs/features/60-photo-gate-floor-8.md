...
> Feature branch: `feat/bin-78-photo-floor-8` · Linear: `BIN-78` · Status: implemented
...
```
 ...
 docs/features/60-photo-gate-floor-8.md          | NEW — this doc
```
...
- Related: `docs/features/58-min-photo-count-gate.md` (original gate).
