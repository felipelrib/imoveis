...
```
 ...
 docs/features/BIN-89-transit-proximity.md             | Notes → shipped link
 docs/features/BIN-118-persist-transit-stops.md         | Notes → headways shipped
 docs/features/BIN-119-gtfs-transit-headways.md         | NEW — this doc
```
