...
> Feature branch: `feat/scraper-regression-gates` · Linear: `BIN-179` · Status: implemented
...
```
 ...
 docs/features/BIN-179-scraper-regression-gates.md       | NEW — this note
 docs/features/BIN-178-fix-quintoandar-olx-scrapers.md | Note live dry-run vs unit gates
```
