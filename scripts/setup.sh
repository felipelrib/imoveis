...
echo "    2. ./scripts/restart.sh   # if you just added/changed API_KEY"
echo "    3. ./scripts/dev.sh       # day-to-day: backend + Vite hot-reload"
echo "    4. Paste that same API_KEY into the sidebar \"API credential\" field"
echo ""
